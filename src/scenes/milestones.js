  ...
  return (
    <>
      <Parallax factor={0.8} position={start} offset={-100} stay={1000}>
        <img src="/matsurisu_en/static/img/classroom.png" alt="classroom" />
      </Parallax>
      <Parallax factor={0.9} position={start} offset={-100} stay={1000}>
        <img src="/matsurisu_en/static/img/desk.png" alt="desk" />
      </Parallax>
      ...
      <Fade start={start + 300} end={start + 800} offset={230}>
        <p className="title">At 50,000 we watched her become 3D</p>
      </Fade>
    </>
  );
}
  ...
  return (
    <>
      <Parallax factor={0.8} position={start} offset={-60} stay={1000}>
        <img src="/matsurisu_en/static/img/shelves.png" alt="shelves" style={{width: 335, height: 'auto', marginLeft: 0}} />
        <img src="/matsurisu_en/static/img/shelves.png" alt="shelves" style={{width: 335, height: 'auto', marginLeft: -45}} />
      </Parallax>
      ...
      <Fade start={start + 300} end={start + 800} offset={160}>
        <p className="title">At 180,000 she was part of the Atre collaboration</p>
      </Fade>
    </>
  );
}
  ...
  return (
    <>
      ...
      <Parallax factor={1.1} position={start} offset={-60} stay={1000}>
        <img src="/matsurisu_en/static/img/TV.png" alt="TV" style={{width: 400, height: 'auto', marginLeft: -20}} />
      </Parallax>
      <Fade start={start + 300} end={start + 800} offset={130}>
        <p className="title">At 280,000 we watched her on TV</p>
      </Fade>
    </>
  );
}
...
export function MilestoneDonuts({ start }) {
  return (
    <>
      <Parallax factor={0.8} position={start} offset={-60} stay={1000}>
        <img src="/matsurisu_en/static/img/bgdonut.png" alt="donut" style={{display: 'block', width: 300, height: 'auto', margin: '0 auto'}} />
      </Parallax>
      ...
      <Fade start={start + 300} end={start + 800} offset={175}>
        <p className="title">At 440,000 she got to collaborate</p>
        <p className="title">with her favorite donut brand</p>
      </Fade>
    </>
  );
}
